...
assert(!fs.readdirSync(root).some(name => name.toLowerCase().endsWith(".bat")), "BAT file included in current source");

console.log("DESTRUCTIVE_OPERATION_GUARD_CURRENT_OK");
