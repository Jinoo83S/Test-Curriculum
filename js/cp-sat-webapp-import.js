import { buildSolverConstraintSummary } from "./timetable-constraint-model.js?v=2026-07-03-manual-card-vault-syntaxfix-r215";
// ================================================================
...
const CP_SAT_WEBAPP_SOURCE = "cp-sat-webapp-r215";
const CP_SAT_BRIDGE_SOURCE = "HIS webapp r215 CP-SAT API bridge";
...
function applyManualCardExclusionToPayloadTimetable(tt = {}) {
  ...
  tt.autoAssignMeta.manualCardExclusionMode = "r215-manual-card-vault";
  return tt;
}
