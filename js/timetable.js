...
import { versioned } from "./version.js?v=2026-06-26-cpsat-r179";
import { openFirestoreUsageDialog } from "./firestore-usage.js";
import { openAppHealthCheckDialog } from "./app-health-check.js?v=2026-06-26-r179";
...
function setupTtSaveQuotaControls() {
  ...
  if (LOCAL_DEV_MODE) {
    ...
    // r179: 운영자가 쓰는 진단/사용량 버튼은 다시 상단에 둡니다.
    // 기능 구분:
