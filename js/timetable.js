...
import { appState, subscribeDomains, unsubscribeAll, setOnUpdate, scheduleSave, saveNow,
         ...
         exportLocalSnapshot, importLocalSnapshot, resetLocalSnapshot, exportFirestoreDiagnosticSnapshot } from "./state.js?v=2026-07-14-school-year-login-hotfix-r346";
...
import { openFirestoreUsageDialog } from "./firestore-usage.js?v=2026-07-14-school-year-login-hotfix-r346";
import { openAppHealthCheckDialog } from "./app-health-check.js?v=2026-07-14-school-year-login-hotfix-r346";
import { getTemplateById, getTemplateCardTitle, splitTeacherNames } from "./templates.js?v=2026-07-14-school-year-login-hotfix-r346";
import { uid, clean, makeBtn, sectionLabel, gradeDisplay, escapeHtml, isProtectedWholeGradeLabel } from "./utils.js";
import { getRooms, getRoomById, renderRoomsView, updateRoom, formatHomeRoomClassLabel } from "./rooms.js?v=2026-07-14-school-year-login-hotfix-r346";
import {
