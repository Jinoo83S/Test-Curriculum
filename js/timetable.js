...
import { createAutoAssignAll } from "./timetable-autoassign.js?v=auto_fail_diag_r1";
...
import { createTimetableLogHandlers } from "./timetable-log.js?v=auto_fail_diag_r1";
import { createTimetableSidebarHandlers } from "./timetable-sidebar.js?v=auto_fail_diag_r1";
