...
import { normalizeTeacherEvents, resolveTeacherEventNames, teacherEventSlots } from "./timetable-teacher-events.js?v=1.0.0-20260724.2";
import {
  getAllClasses,
  getTtCardClassInfos,
  entryHasGrade,
...
function renderTeacherGrid(wrap, ctx) {
  ...
  const rowCount = Math.max(1, classes.length + 1);
