...
// ================================================================
import { ACTIVE_SCHOOL_YEAR, LEGACY_SCHOOL_YEAR, setupSchoolYearUi } from "./school-year.js?v=2026-07-15-school-year-verification-lifecycle-r352";
...
async function seedLocalStateFromCurrentRuntime() {
  ...
  try {
    const mod = await import("./state.js?v=2026-07-15-school-year-verification-lifecycle-r352");
...
function setupTopModeSwitchButtons() {
  try {
    ...
    // A topbar decoration failure must not stop Firebase auth/app initialization.
    console.error("[local-dev] School-year UI setup failed; login will continue.", error);
  }
  applyDeveloperToolsVisibility();
  const localBtn = document.getElementById("topLocalModeBtn");
