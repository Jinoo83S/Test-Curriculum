...
// ================================================================
import { ACTIVE_SCHOOL_YEAR, LEGACY_SCHOOL_YEAR, setupSchoolYearUi } from "./school-year.js?v=1.0.0-20260724.1";
...
async function seedLocalStateFromCurrentRuntime() {
  ...
  try {
    const mod = await import("./state.js?v=1.0.0-20260724.1");
