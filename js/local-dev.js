...
// ================================================================
import { ACTIVE_SCHOOL_YEAR, LEGACY_SCHOOL_YEAR, setupSchoolYearUi } from "./school-year.js?v=2026-07-14-school-year-isolation-r351";
...
async function seedLocalStateFromCurrentRuntime() {
  ...
  try {
    const mod = await import("./state.js?v=2026-07-14-school-year-isolation-r351");
