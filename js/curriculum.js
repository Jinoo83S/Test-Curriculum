...
// ================================================================
import { GRADE_KEYS, GRADE_GROUPS, SEMESTER_LABELS, CATEGORY_PALETTE, DEFAULT_OPTIONS, DEFAULT_COL_WIDTHS } from "./config.js?v=2026-07-15-school-year-verification-lifecycle-r352";
import { uid, clean, uniqueOrdered, parseCreditValue, makeBtn, languageClass } from "./utils.js?v=2026-07-15-school-year-verification-lifecycle-r352";
import { canEdit } from "./auth.js?v=2026-07-15-school-year-verification-lifecycle-r352";
import { appState, scheduleSave, ensureConsistency, createRow, normalizeRow, loadColWidths, saveColWidths, currentDrag, setCurrentDrag, normalizeTemplate } from "./state.js?v=2026-07-15-school-year-verification-lifecycle-r352";
...
import { getTemplateById, getSemesterTemplateData, isSemesterDataSame, getTemplateGroupById, getTemplateCardTitle, getTemplateAppliedGrades } from "./templates.js?v=2026-07-15-school-year-verification-lifecycle-r352";
