...
import { ACTIVE_SCHOOL_YEAR, IS_LEGACY_SCHOOL_YEAR, LEGACY_SCHOOL_YEAR, assertSchoolYearRuntimeConsistency } from "./school-year.js?v=1.0.0-20260724.1";
import { getSchoolYearPathSpec, assertSchoolYearPathSpec, pathSegmentsToString } from "./school-year-paths.js?v=1.0.0-20260724.1";
