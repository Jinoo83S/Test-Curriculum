...
globalThis.HIS_AUTOASSIGN_BUILD = "2026-06-23-groupcard-realmerge-r100";
...
export function createAutoAssignAll(deps) {
  ...
  function compactAutoAssignSnapshotMeta(meta = {}) {
    ...
    return {
      ...
      validatorVersion: String(meta.validatorVersion || "2026-06-23-groupcard-realmerge-r100"),
  ...
  function attachCanonicalMetaToMatchingSnapshots(domain, canonicalMeta = {}, canonicalEntries = []) {
    ...
    const compact = compactAutoAssignSnapshotMeta({
      ...canonicalMeta,
      schemaVersion: canonicalMeta.schemaVersion || "2026-06-23-groupcard-realmerge-r100",
  ...
  async function autoAssignAll() {
    ...
    try {
      ...
      const report = {
        ...
        validatorVersion: "2026-06-23-groupcard-realmerge-r100"
      };
