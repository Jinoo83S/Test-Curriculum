...
import { isExperimentalResidualRepairEnabled, stripStaleResidualPuzzleReport } from "./timetable-validator.js?v=2026-07-14-school-year-isolation-r351";

globalThis.HIS_AUTOASSIGN_BUILD = "2026-07-14-school-year-isolation-r351";
...
export function createAutoAssignAll(deps) {
  ...
  function compactAutoAssignSnapshotMeta(meta = {}) {
    ...
    return {
      ...
      validatorVersion: String(meta.validatorVersion || "2026-07-14-school-year-isolation-r351"),
  ...
  function attachCanonicalMetaToMatchingSnapshots(domain, canonicalMeta = {}, canonicalEntries = []) {
    ...
    const compact = compactAutoAssignSnapshotMeta({
      ...canonicalMeta,
      schemaVersion: canonicalMeta.schemaVersion || "2026-07-14-school-year-isolation-r351",
  ...
  async function autoAssignAll() {
    ...
    try {
      ...
      const report = {
        ...
        validatorVersion: "2026-07-14-school-year-isolation-r351"
      };
