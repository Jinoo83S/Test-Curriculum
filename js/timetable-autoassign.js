...
export function createAutoAssignAll(deps) {
  ...
  function compactAutoAssignSnapshotMeta(meta = {}) {
    ...
    return {
      ...
      validatorVersion: String(meta.validatorVersion || "2026-07-03-room-rule-manual-priority-r208"),
  ...
  function attachCanonicalMetaToMatchingSnapshots(domain, canonicalMeta = {}, canonicalEntries = []) {
    ...
    const compact = compactAutoAssignSnapshotMeta({
      ...canonicalMeta,
      schemaVersion: canonicalMeta.schemaVersion || "2026-07-03-room-rule-manual-priority-r208",
  ...
  async function autoAssignAll() {
    ...
    try {
      ...
      const report = {
        ...
        validatorVersion: "2026-07-03-room-rule-manual-priority-r208"
      };
