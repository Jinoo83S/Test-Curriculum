...
import { isExperimentalResidualRepairEnabled, stripStaleResidualPuzzleReport } from "./timetable-validator.js?v=2026-07-15-school-year-path-guard-r353";

globalThis.HIS_AUTOASSIGN_BUILD = "2026-07-15-school-year-path-guard-r353";
...
export function createAutoAssignAll(deps) {
  ...
  function compactAutoAssignSnapshotMeta(meta = {}) {
    ...
    return {
      ...
      validatorVersion: String(meta.validatorVersion || "2026-07-15-school-year-path-guard-r353"),
  ...
  function attachCanonicalMetaToMatchingSnapshots(domain, canonicalMeta = {}, canonicalEntries = []) {
    ...
    const compact = compactAutoAssignSnapshotMeta({
      ...canonicalMeta,
      schemaVersion: canonicalMeta.schemaVersion || "2026-07-15-school-year-path-guard-r353",
  ...
  async function autoAssignAll() {
    ...
    try {
      ...
      const report = {
        ...
        validatorVersion: "2026-07-15-school-year-path-guard-r353"
      };
